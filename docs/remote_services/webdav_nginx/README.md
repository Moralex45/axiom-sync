...
The description is adapted from the pull request [`dgraziotin/docker-nginx-webdav-nononsense#123`](https://github.com/dgraziotin/docker-nginx-webdav-nononsense/pull/123) by Axiom Sync author.
...
Then, in Axiom Sync's setting, set these (auth type should always be `Basic`):
