...
3. Go back to your Axiom Sync plugin inside Obsidian, click "Check again" button in PRO settings. So that the plugin knows some features are enabled. In this case, sync with Yandex Disk should be detected.

## Steps of Connecting to your Yandex Disk

After you enabled the PRO feature in your Axiom Sync plugin, you can connect to your Yandex Disk account now.

1. In Axiom Sync settings, change your sync service to Yandex Disk.
2. Click Auth, visit the link, go to Yandex Disk website to start.
3. Follow the instruction on Yandex Disk, and allow Axiom Sync to connect.
...
1. The Axiom Sync PRO feture "sync with Yandex Disk" is developed using Yandex Disk's native API, instead of webdav interface. It brings benefits such that the last modified time can be preserved.
