...
3. Go back to your Axiom Sync plugin inside Obsidian, click "Check again" button in PRO settings. So that the plugin knows some features are enabled. In this case, sync with Box should be detected.

## Steps of Connecting to your Box

After you enabled the PRO feature in your Axiom Sync plugin, you can connect to your Box account now.

1. In Axiom Sync settings, change your sync service to Box.
2. Click Auth, visit the link, go to Box website to start.
3. Follow the instruction on Box, and allow Axiom Sync to connect.
