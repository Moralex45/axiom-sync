...
The tutorial author (the author of Axiom Sync) is NOT an expert of NAS / Synology. Please read the doc carefully and change it to accommodate your needs by yourself.
...
6. In Axiom Sync settings, you should input your address as:
