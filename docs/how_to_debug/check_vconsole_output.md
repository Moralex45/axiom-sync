...
4. You can copy (by clicking the small "disk" icon beside each line of the log) or take a screenshot of the logs, and report bugs in Axiom Sync GitHub. You can click "Hide" in the panel to hide the panel.
