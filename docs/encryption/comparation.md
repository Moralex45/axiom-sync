...
1. Anyway, security is a hard problem. The author of Axiom Sync doesn't have sufficient knowledge to "judge" which one is the better format. **Use them at your own risk.**
2. Currently the RClone Crypt format is recommended by default in Axiom Sync. Just because of the taste from the Axiom Sync author, who likes RClone.
