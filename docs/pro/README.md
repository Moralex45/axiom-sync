...
From version 0.5.x, Axiom Sync introduces PRO (paid) features. Users need to subscribe to (pay) them to use them.

**If you are using basic features only, you don't need an online account, and you don't need to pay for the plugin.**

# Links

* Axiom Sync official website: <https://remotelysave.com>
...
1. Go to the website, sign up and sign in. You can directly visit <https://remotelysave.com/user/signupin> or click the link in Axiom Sync plugin setting page.
    ![pro setting](./pro_setting.png)
2. Use an email and your password as usual. Don't need to be GMail account.

## Steps of connecting

You need to connect your plugin to your online account. In Obsidian, in your Axiom Sync plugin setting, you can click the button "Connect" to start the flow.
...
3. Go back to your Axiom Sync plugin inside Obsidian, click "Check again" button in PRO settings. So that the plugin knows some features are enabled.
